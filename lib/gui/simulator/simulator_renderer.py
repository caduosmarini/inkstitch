...
class PreviewRenderer(Thread):
    ...
    def __init__(
        ...
        self.render_stitch_plan_hook = render_stitch_plan
        self.rendering_completed_hook = rendering_completed
    ...
    @debug.time
    def render_stitch_plan(self, request_id: int) -> None:
        try:
    ...
    def _rendering_completed(
            self, request_id: int, stitch_plan: StitchPlan | None
            ) -> None:
